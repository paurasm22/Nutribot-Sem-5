    ...
    <>
      {location.pathname === "/landingpage" && (
        <div className="h-[65px] bg-gray-200 shadow-md sticky top-0 z-50  ">
          ...
          >
            <div className="logo flex items-center justify-start  align-middle cursor-pointer ">
              <img
                src={nutibgremvoed}
            ...
            <div className="options flex justify-center items-center place-items-center mb-2">
              ...
              <button
                className="bg-green-400 y-300 hover:bg-green-300 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center ml-2"
